    ...
    <div className="features-page">
      ...
      <section className="features-hero">
        <div className="hero-content">
          ...
          <p>Discover the comprehensive suite of tools and capabilities that make
            ATC Capital the leading choice for financial management.
          </p>
        </div>
      </section>
      ...
      <section className="features-cta">
        <div className="container">
          ...
          <p>Start your free trial today and discover how ATC Capital can transform your financial management.</p>
