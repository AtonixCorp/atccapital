  ...
  const tutorials = [
    {
      ...
      duration: "5 min",
      description: "Get familiar with the Atonix Capital platform interface and key features."
    },
    {
    ...
    },
    {
      ...
      duration: "6 min",
      description: "Master the Atonix Capital mobile app for trading on the go."
    }
  ];
            ...
            <div className="contact-text">
              ...
              <div className="contact-options">
                ...
                <div className="contact-option">
                  ...
                  <a href="mailto:support@atonixcapital.com" className="contact-btn">Email Us</a>
                </div>
                <div className="contact-option">
                  <h4>Phone Support</h4>
